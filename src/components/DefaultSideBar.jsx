...
const items = [1,2,3,4,5,6]
  ...
  return (
    <div className=' flex flex-col w-20 mt-2  items-center h-full' >
        {items.map((itm, ind)=> {
          return (
            <Link to="/" className='w-full ml-1' >
              <div key={ind} className='flex w-full my-0 py-5 hover:rounded-2xl flex-col items-center hover:cursor-pointer hover:bg-gray-100'> 
